...
namespace ProtocolHandle
{
    ...
    public class C2Gate_RequestOrderRequestHandler : AMRpcHandler<C2Gate_RequestOrderRequest>
    {
        ...
        {
            C2Gate_RequestOrderRequest req = package.msg as C2Gate_RequestOrderRequest;
            Gate2C_RequestOrderResponse response = package.Response as Gate2C_RequestOrderResponse;
