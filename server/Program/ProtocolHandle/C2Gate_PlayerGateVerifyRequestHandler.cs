...
namespace ProtocolHandle
{
    ...
    public class C2Gate_PlayerGateVerifyRequestHandler : AMRpcHandler<C2Gate_PlayerGateVerifyRequest>
    {
        ...
        {
            C2Gate_PlayerGateVerifyRequest req = package.msg as C2Gate_PlayerGateVerifyRequest;
            Gate2C_PlayerGateVerifyResponse response = package.Response as Gate2C_PlayerGateVerifyResponse;
            ...
            try
            {
                ...
                //TranspondComponent.instance.Add(req.id, package.Source);
