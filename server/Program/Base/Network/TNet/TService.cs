...
namespace Base
{
	public sealed class TService: AService
	{
        ...
        private void OnAcceptComplete(object o)
        {
            ...
            TChannel channel = ObjectPoolManager.Instance.Take<TChannel,long, Socket, TService>(IdGenerater.GenerateId(), e.AcceptSocket, this);
        ...
        {
            TChannel channel = ObjectPoolManager.Instance.Take<TChannel, long, IPEndPoint, TService>(IdGenerater.GenerateId(), ipEndPoint, this);
            this.idChannels[channel.Id] = channel;
            return channel;
        }
