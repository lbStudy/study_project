...
{
    unsafe class Data_L2C_LoginResponse_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Data.L2C_LoginResponse);
            args = new Type[]{};
            ...
            args = new Type[]{};
            method = type.GetMethod("get_areas", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_areas_2);
        ...
        static StackObject* get_errorCode_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Data.L2C_LoginResponse instance_of_this_method = (Data.L2C_LoginResponse)typeof(Data.L2C_LoginResponse).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* get_areas_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.areas;
