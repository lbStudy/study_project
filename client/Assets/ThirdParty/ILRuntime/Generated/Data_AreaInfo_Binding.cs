...
{
    unsafe class Data_AreaInfo_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Data.AreaInfo);
            args = new Type[]{};
        ...
        static StackObject* get_id_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Data.AreaInfo instance_of_this_method = (Data.AreaInfo)typeof(Data.AreaInfo).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
