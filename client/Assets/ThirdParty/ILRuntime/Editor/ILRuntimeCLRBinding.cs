...
public class ILRuntimeCLRBinding
{
    ...
    static void GenerateCLRBinding()
    {
        ...
        types.Add(typeof(List<AudioSource>));
    ...
    static void GenerateCLRBindingByAnalysis()
    {
        ...
        using (System.IO.FileStream fs = new System.IO.FileStream("Assets/Hotfix_ab/Hotfix.dll.bytes", System.IO.FileMode.Open, System.IO.FileAccess.Read))
        {
    ...
    static void InitILRuntime(ILRuntime.Runtime.Enviorment.AppDomain domain)
    {
        ...
        //这里需要注册所有热更DLL中用到的跨域继承Adapter，否则无法正确抓取引用
        // 注册适配器
        Assembly assembly = typeof(Begin).Assembly;
